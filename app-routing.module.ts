...
import { GlaAdjustmentComponent } from './views/components/gla-adjustment/gla-adjustment.component';

import { NgModule } from '@angular/core';
import { RouterModule, Route } from '@angular/router';

const routes: Route[] = [
  { path: '', pathMatch: 'full', redirectTo: 'dashboards/v2' },
  {
    path: 'dashboards',
    children: [
...

  {
    path: 'components',
    children: [
      { path: 'gla-adjustment', component: GlaAdjustmentComponent },
